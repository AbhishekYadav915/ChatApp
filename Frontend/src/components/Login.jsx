  ...
  return (
    ...
    <div className=' flex  h-screen items-center justify-center bg-current'>
        <form onSubmit={handleSubmit(onSubmit)}  className='border border-white px-6 py-2 rounded-md space-y-3 w-96'>
            <h1 className='text-2xl text-center text-yellow-300'>Chat<span className='text-green-600 font-semibold'>App</span></h1>
...
<p>New User?<NavLink to={'/signup'} className='text-blue-700 underline cursor-pointer ml-1'>Signup</NavLink></p>
